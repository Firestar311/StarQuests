 ...
 */
public class ItemConsumeAction extends EventAmountAction<Material, PlayerItemConsumeEvent> {
    ...
    @Override
    protected void handleEvent(PlayerItemConsumeEvent event, Player player, Quest quest, QuestObjective questObjective, StorageHandler storageHandler, AmountQuestData questData) {
